...
export function NewOrderForm() {
  const { data, today, mode, createOrder, saveCustomer } = useWorkspace();
  const router = useRouter();
...
export function OrderDetail({ id }: { id: string }) {
  const { data, advancePiece, recordPayment, deliver, rework } = useWorkspace();
