...
const commit = process.env.HISTORY_RELEASE_COMMIT;
const deployment = process.env.HISTORY_RELEASE_DEPLOYMENT;
...
await writeFile('output/qa/history-ui-production-release.json', JSON.stringify(report,null,2)+'\n');
